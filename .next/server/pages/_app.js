...
// EXTERNAL MODULE: external "graphql-ws"
var external_graphql_ws_ = __webpack_require__("MTzx");

// EXTERNAL MODULE: ./auth/auth.js
var auth = __webpack_require__("hfBf");
...
function isSubscription({
  ...
  const definition = Object(utilities["getMainDefinition"])(query);
  return definition.kind === external_graphql_["Kind"].OPERATION_DEFINITION && definition.operation === external_graphql_["OperationTypeNode"].SUBSCRIPTION;
}
...
function PedidoReducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function PedidoReducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { PedidoReducer_ownKeys(Object(source), true).forEach(function (key) { PedidoReducer_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { PedidoReducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
const PedidoReducer = (state, action) => {
  switch (action.type) {
    case SELECCIONAR_CLIENTE:
      return PedidoReducer_objectSpread(PedidoReducer_objectSpread({}, state), {}, {
...
/* harmony default export */ var pedidos_PedidoReducer = (PedidoReducer);
// CONCATENATED MODULE: ./context/pedidos/PedidoState.js
var __jsx = external_react_default.a.createElement;

function PedidoState_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function PedidoState_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { PedidoState_ownKeys(Object(source), true).forEach(function (key) { PedidoState_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { PedidoState_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
const PedidoState = ({
  ...
  const {
    0: state,
    1: dispatch
  } = Object(external_react_["useReducer"])(pedidos_PedidoReducer, initialState);
  ...
  const agregarProductos = productosSeleccionados => {
    ...
    if (state.productos.length > 0) {
      ...
      nuevoState = productosSeleccionados.map(producto => {
        ...
        return PedidoState_objectSpread(PedidoState_objectSpread({}, producto), nuevoObjeto);
      });
    } else {
...
var graphql = __webpack_require__("T7Fc");
var tslib = __webpack_require__("pPc8");
var zenObservableTs = __webpack_require__("zhCW");
...
var tslib = __webpack_require__("ED6n");
